...
import { FaWhatsapp } from "react-icons/fa"; // install react-icons if not already: npm i react-icons
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ name: "", email: "", service: "Solar Design & Installation", message: "" });
    } catch (err) {
  ...
  return (
    <section className="relative max-w-5xl mx-auto px-6 py-16">
      ...
      <a
        href="https://wa.me/2347032751067" // <-- replace with your WhatsApp number in international format
        target="_blank"
